		...
		<tr>
			...
			<table border="1" width="100%" id="table2" style="border-collapse: collapse" dir="ltr">
				<tr>
					...
					<td align="center" bgcolor="#E6B86B"><b><font size="2">Name</font></b></td>
					<td align="center" bgcolor="#E6B86B"><b><font size="2">
					Basic</font></b></td>
					<td align="center" bgcolor="#E6B86B"><b><font size="2">50% from Basic Salary
					</font></b></td>
					<td align="center" bgcolor="#E6B86B"><b><font size="2">Official Hours
					</font></b></td>
					<td align="center" bgcolor="#E6B86B"><b><font size="2">vacation Hours 
					</font></b></td>
					<td align="center" bgcolor="#E6B86B"><b><font size="2">Off Days Hours
					</font></b></td>
					<td align="center" bgcolor="#E6B86B"><b><font size="2">Extra Payment
					</font></b></td>
					<td align="center" bgcolor="#E6B86B"><b><font size="2">Pay Owed 
					</font></b></td>
					<td align="center" bgcolor="#E6B86B"><b><font size="2">
					Signature</font></b></td>
				</tr>
...
?>
	...
	<!--//////////////////////////////////////////////////نهاية عرض الموظفين حسب القسم///////////////////////////////////////////////-->
		...
		<tr>
			<td colspan="4">
			<div align="center">
				<table border="1" width="100%" id="table3" style="border-collapse: collapse" dir="ltr">
					<tr>
						...
						<font size="2">50% Basic Total</font></b></td>
						<td bgcolor="#E6B86B" width="63" align="center"><b>
						<font size="2">Official</font></b></td>
						<td bgcolor="#E6B86B" width="66" align="center"><b>
						<font size="2">Vacation</font></b></td>
					...
					<tr>
						<td width="32%">&nbsp;</td>
						<td width="10%">
						<p align="center"><b><font size="2"><?php echo number_format(round(@$sum_salary,2),2,'.',', ');?></font></b></td>
						<td width="10%" align="center"><b><font size="2"><?php echo number_format(round(@$sum_havsal,2),2,'.',', ');?></font></b></td>
						<td width="10%" align="center"><b><font size="2"><?php echo number_format(round(@$sum_normal1,2),2,'.',', ');?></font></b></td>
						<td width="10%" align="center"><b><font size="2"><?php echo number_format(round(@$sum_holidy,2),2,'.',', ');?></font></b></td>
						<td width="10%" align="center"><b><font size="2"><?php echo number_format(round(@$sum_holidy_emp,2),2,'.',', ');?></font></b></td>
						<td width="10%" align="center"><b><font size="2"><?php echo number_format(round(@$sum_total,2),2,'.',', ');?></font></b></td>
						<td align="center" width="10%"><b><font size="2"><?php echo number_format(round(@$sum_push,2),2,'.',', ');?></font></b></td>
					</tr>
				</table>
			</div>
			</td>
