...
/**********************إجمالي المرتب*************************/
	...
	//$totsal=@$cloth+@$manager+@$cashequal+@$gravity+@$mobil+@$tension+@$capital1+@$sal_differ+@$work+@$cash_chaild+@$cash_statas+@$sal1;//جملة الراتب
//			
...
$rs_cut=mysql_query("select *from tb_tax where id=$emp_id");
	...
	$sum_charity=0;//@$sum_charity+$charity;
	
	$tax=@mysql_result($rs_cut,0,'tax');//الضريبة
	$sum_tax=25000;//@$sum_tax+$tax;
	
	if(@mysql_result($rs_emp,$i,'bank_id')!=20)
	$tameen=17*$totsal/100;
	else
	$tameen=0;
	if(@mysql_result($rs_emp,$i,'name')!="")
...
$sum_lone=0;//round($total_lone,2)+@$sum_lone;
/*--------------------End---------------------------*/
/*--------------------الجزاءات-----------------------*/
...
$sum_cut=0;//@$sum_cut+round($cut_daycash,2);
/*--------------------End---------------------------*/


/**********************جملة الاستقطاعات*************************/
$total_dis=$tameen+$tax+$charity+$total_lone;
	if(@mysql_result($rs_emp,$i,'name')!="")
...
<table dir="ltr" style="border-collapse: collapse">
	<tr>
		...
		<td width="2%" height="25" align="center" valign="top" bgcolor="#E6B86B" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
		<font size="1"><b>Housing</b></font></td>
		<td width="2%" height="25" align="center" valign="top" bgcolor="#E6B86B" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
		<font size="1"><b>Children</b></font></td>
		<td width="2%" height="25" align="center" valign="top" bgcolor="#E6B86B" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
		<font size="1"><b>Work</b></font></td>
		<td width="2%" height="25" align="center" valign="top" bgcolor="#E6B86B" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
		<font size="1"><b>Mobile</b></font></td>
		<td width="2%" height="25" align="center" valign="top" bgcolor="#E6B86B" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
		<font size="1"><b>Department</b></font></td>
		<td width="2%" height="25" align="center" valign="top" bgcolor="#E6B86B" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
		<font size="1"><b>Internet</b></font></td>
		<td width="2%" height="25" align="center" valign="top" bgcolor="#E6B86B" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
		<font size="1"><b>Appearance</b></font></td>
		<td width="2%" height="25" align="center" valign="top" bgcolor="#E6B86B" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
		<font size="1"><b>Capital</b></font><b><font size="1"> </font></b></td>
		<td width="2%" height="25" align="center" valign="top" bgcolor="#E6B86B" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
		<font size="1"><b>Tension</b></font></td>
		<td width="2%" height="25" align="center" valign="top" bgcolor="#E6B86B" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
		<font size="1"><b>Rewards</b></font></td>
		...
		<font size="1"><b>Salary Allowance</b></font></td>
		<td width="1%" height="25" align="center" valign="top" bgcolor="#E6B86B" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
		<font size="1"><b>Addition</b></font></td>
		<td width="2%" height="25" align="center" valign="top" bgcolor="#E6B86B" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
		<font size="1"><b>Total Salary</b></font><b><font size="1"> </font></b></td>
		<td width="2%" height="25" align="center" valign="top" bgcolor="#E6B86B" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
		<font size="1"><b>Extra Payment</b></font></td>
		<td width="2%" height="25" align="center" valign="top" bgcolor="#E6B86B" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
		<font size="1"><b>17% Insurance</b></font><b><font size="1"> </font></b></td>
		<td width="2%" height="25" align="center" valign="top" bgcolor="#E6B86B" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
		Total Salaries</td>
		</tr>
	<tr>
	...
	<?php echo number_format(round(@$sum_cashequal,2),2,'.',', ');?></font></b></td>
		...
		<b><font size="2">
		<?php 
		$sum_safee=round(@$sum_tameen,2)+round(@$sum_tax,2)+round(@$sum_totsal,2);
