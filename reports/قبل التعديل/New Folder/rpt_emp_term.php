...
<form method="POST" action="">
	...
	<table width="75%" style="border-style:solid; border-width:0; border-collapse: collapse; padding-left:4px; padding-right:4px; padding-top:1px; padding-bottom:1px" dir="rtl" id="table5">
		...
		<td width="98%" align="left" colspan="21" class="tdtitleemp" bgcolor="#FFFFFF">
			...
			<tr>
				...
				<span lang="ar-sa">قناة الشروق الفضائية</span></font>
				<p align="center"><font size="4">Ashorooq TV
				</b></font></td>
			</tr>
			<tr>
				...
				<p align="center"><span lang="ar-sa"><b><font size="4">مكتب السودان</font></b></span>
				<table border="0" width="90%" id="table7">
					<tr>
						<td width="98%"><span lang="ar-sa"><b>التاريخ:</b>
						<?php echo date("Y/m/d");?></span></td>
					</tr>
					<tr>
						<td>
						<p align="right"><b><span lang="ar-sa"><font size="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
						السيد </font></span><font size="4">/ </font>
						<span lang="ar-sa"><font size="4">مدير مكتب السودان
						</font></span></b></td>
					</tr>
					<tr>
						<td>
						<p align="center"><b><span lang="ar-sa"><font size="4">&nbsp;&nbsp; 
						بواسطة&nbsp; رئيس قسم الشئون الادارية والمالية </font>
						</span></b>
						</td>
					</tr>
					<tr>
						<td>
						<p align="center"><span lang="ar-sa">السلام عليكم ورحمة 
						الله وبركاته</span></td>
					</tr>
					<tr>
						<td>
						<p align="center"><u><b><span lang="ar-sa">
						<font size="4">الموضوع : استحقاقات الموظف </font></span>
	...
	<table border="0" width="100%" id="table8">
		<tr>
			<td width="20%"><b><span lang="ar-sa">تاريخ التعيين:</span></b></td>
			<td><?php echo $employmentDate ?></td>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
			<td width="20%"><b><span lang="ar-sa">تاريخ بداية العمل:</td>
			<td><?php echo $workBeginDate ?></td>
		</tr>
		<tr>
			<td width="20%"><b><span lang="ar-sa">تاريخ انهاء العقد:</span></b></td>
			<td><?php echo $rptdate ?></td>
			<td>&nbsp;&nbsp;&nbsp;</td>
			<td width="25%"><b><span lang="ar-sa">فترة العمل بالشهور:</span></b></td>
			<td><?php echo $workMonths;?></td>
		</tr>
		<tr>
			<td width="20%"><b><span lang="ar-sa">سبب ترك العمل:</span></b></td>
			<td><?php echo $termName ?></td>
			<td>&nbsp;&nbsp;&nbsp;</td>
			<td width="25%"><b><span lang="ar-sa">مكان صرف الراتب:</span></b></td>
			<td><?php echo $bankName;?></td>
		</tr>
	</table>
	<div align="right">			
	<table class="sample" dir="rtl"  width="81%">		
		<tr>
			<td width="5%" align="center" rowspan="2"><b><span lang="ar-sa"> &nbsp;#</span></b></td>
			<td width="63%" align="center" rowspan="2"><b><span lang="ar-sa"> &nbsp;&nbsp;البند</span></b></td>
			<td width="32%" align="center" colspan="2"><b><span lang="ar-sa"> &nbsp;&nbsp;المبلغ</span></b></td>
		</tr>
		<tr>
			<td width="15%" align="center"><b>له </b></td>
			<td width="17%" align="center"><b>علية</b></td>
		</tr>
		<tr>
			<td width="5%" align="center"><b><span lang="ar-sa"> &nbsp;1</span></b></td>
			<td width="63%"><b><span lang="ar-sa"> &nbsp;&nbsp;فوائد مابعد الخدمة</span></b></td>
			<td width="15%">&nbsp;&nbsp;<?php echo $endWorkSalary; ?></td>
			<td width="17%">&nbsp;</td>
		</tr>
		<tr>
			<td width="5%" align="center"><b><span lang="ar-sa"> &nbsp;2</span></b></td>
			<td width="63%"><b><span lang="ar-sa">&nbsp;&nbsp;راتب الشهر الاخير&nbsp;(</span>&nbsp;<?php if(isset($_POST['calcLastMonthSalary'])) echo $dayend[2]; else echo "0";?>&nbsp; <span lang="ar-sa">) يوم </span></b></td>
			<td width="15%">&nbsp;&nbsp;<?php echo $lastSalary; ?></td>
			<td width="17%">&nbsp;</td>
		</tr>
		<tr>
			<td width="5%" align="center"><b><span lang="ar-sa"> &nbsp;3</span></b></td>
			<td width="63%"><b><span lang="ar-sa">&nbsp;&nbsp;متأخرات أجر أضافي<?php if(strlen($displayMonthNames) > 2) echo  $displayMonthNames;?> </span></b></td>
		...
		<tr>
			...
			<td width="63%"><b><span lang="ar-sa">&nbsp;&nbsp;أخرى</span></b></td>
			<td width="15%"></td>
			<td width="17%">&nbsp;&nbsp;<?php echo $otherMony; ?></td>
		</tr>
		<tr>
			<td width="67%" align="center" colspan="2"><p align="center"><b>المجموع</b></p></td>
		...
		<tr>
			...
			<td width="63%"  align="center" colspan="2"><p align="center"><b>المبلغ المستحق</b></p></td>
	...
	<table border="0" width="85%" id="table8">
		<br /><br /><br /><br />
		<tr>
			<td width="40%"><b><span lang="ar-sa">إعتماد شئون العاملين ....................................</span></b></td>
			<td>&nbsp;&nbsp;&nbsp;</td>
			<td width="60%"><b><span lang="ar-sa">إعتماد رئيس قسم الشئون الادارية .............................</span></b></td>
