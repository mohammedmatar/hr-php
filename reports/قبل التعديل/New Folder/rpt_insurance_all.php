...
$day=30;
	...
	$date=$year."-".$month."-"."1";
/* ---------------------------------------------------*/
$rs_emp=mysql_query("select *from tb_employee  where des_salary=1 and bank_id<>20 and tameen_date<>'0000-00-00'  order BY name  ");
	...
	<tr>
		...
		<table border="0" width="100%" id="table6">
			...
			<tr>
				...
				<p align="center">
				<b>
				<span lang="ar-sa"><font size="5">الصندوق القومي للتامين الإجتماعي</font></span></b></td>
			</tr>
			<tr>
