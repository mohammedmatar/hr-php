...
<div align="center">
	<table border="0" width="100%" id="table1">
		...
		<tr>
				...
				تقرير مستحقات المتعاونين بتاريخ : 
				<?php echo $rptdate;?>
				&nbsp;</b></b><br>
&nbsp;</td>
			</tr>
		...
		<tr>
			...
			<table border="1" width="100%" id="table2" style="border-collapse: collapse">
				<tr>
					...
					<td align="center" bgcolor="#E6B86B" width="70" height="24"><b>التوقيع</b></td>
				</tr>
...
?>
				<tr>
					...
					<td align="center" width="70"><font size="2"><?php echo $overtime;?></font></td>
					<td align="center" width="70"><?php echo $salary;?></td>
					<td align="center" width="70"><?php echo round($total_lone,2);?></td>
	...
	<!--//////////////////////////////////////////////////نهاية عرض الموظفين حسب القسم///////////////////////////////////////////////-->
		...
		<tr>
			<td colspan="4">
			<table border="1" width="100%" id="table3" style="border-collapse: collapse" bgcolor="#244893">
				<tr>
					...
					الاساسي</b></font></td>
					<td width="70" align="center">
					<font color="#FFFFFF" size="1"><b>غلاء 
					المعيشة</b></font></td>
					<td width="70" align="center">
					<font color="#FFFFFF" size="1"><b>بدل 
					الترحيل</b></font></td>
					<td width="70" align="center">
					<font color="#FFFFFF" size="1"><b>بدل 
					السكن</b></font></td>
					<td width="70" align="center">
					<font color="#FFFFFF" size="1"><b>بدل 
					طبيعة العمل</b></font></td>
					<td width="70" align="center">
					<b><font size="1" color="#FFFFFF">بدل علاج</font></b></td>
					<td width="35" align="center">
					<font color="#FFFFFF" size="1"><b>بدل الأجر الإضافي</b></font></td>
					<td width="35" align="center">
					<font color="#FFFFFF" size="1"><b>السلفيات</b></font></td>
					<td align="center"><font color="#FFFFFF" size="1"><b>صافي الراتب</b></font></td>
				</tr>
				<tr>
					<td width="38%"><b><font color="#FFFFFF">الجملة</font></b></td>
					...
					<td width="35" align="center" bgcolor="#FFFFFF"><b><?php echo $sum_overtime;?></b></td>
					<td width="35" align="center" bgcolor="#FFFFFF"><?php echo round($sum_lone,2);?></td>
