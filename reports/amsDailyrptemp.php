...
<title>LATD TECHNOLOGY-DAILY ATTENDANCE -COLLABORATORS</title>
...
$rs=mysql_query("select *from tb_collaborator  where dis_salary=1 and sec_id=$_POST[section]  order by name");//*/ emp_number=9103
$x=mysql_num_rows($rs);
/*$user="sa";
...
<div align="center">
	<table border="0" width="100%" bgcolor="#FFFFFF" dir="rtl" id="table1">
		...
		<tr>
			<td>
			<p align="center"><font size="4"><b>DAILY ATTENDANCE -COLLABORATORS&nbsp;
			</b></font></td>
		</tr>
		<tr>
			<td>
			...
			<div align="center">
				<table border="0" width="700" bgcolor="#FFFFFF" dir="rtl" id="table3" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
					<tr>
						...
						<td style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" align="center" bgcolor="#E6B86B">
						Leaving Time</td>
