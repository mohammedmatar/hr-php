...
<title>LATD TECHNOLOGY-DAILY ATTENDANCE -Employees </title>
...
<div align="center">
	<table border="0" width="100%" bgcolor="#FFFFFF" dir="rtl" id="table1">
		...
		<tr>
			<td>
			<p align="center"><font size="4"><b>DAILY ATTENDANCE FOR 
			COLLABORATORS PER DEPARTMENT </b></font></td>
		</tr>
		<tr>
			<td>
			<div align="center">
...
?></td>
			...
			<div align="center">
				<table border="0" width="700" bgcolor="#FFFFFF" dir="rtl" id="table3" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
					<tr>
						...
						<td style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" bgcolor="#E6B86B" align="center">
						<b>Leaving Time</b></td>
		...
		$rs=mysql_query("select *from tb_collaborator  where dis_salary= 1   and sec_id =$rowsec[0]    order by name ");//*/ emp_number=9103
		//echo "select *from tb_collaborator  where dis_salary= 1   and sec_id =$rowsec[0]    order by name ";
$x=mysql_num_rows($rs);
if ($x >0 ){
		?>
...
$xholiy=0;//@mysql_num_rows($rs_holiy);
...
// حالة الموظف				
 if(odbc_result($res2,"time")=='00:00:00' || odbc_result($res2,"time")=="" ) 
						{
						if ($xholiy >0)
						$status="<b><font color=#107A02 size=4>annual vacation</font></b>";
						else
						$status= "Absent";
						 }
						 else 
...
$status= "<b><font color=#FF0000>Absent</font></b>";
					...
					<tr>
						...
						<td align="center" style="padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px"><?php 
						...
						<?php echo $status;?></td>
						<td align="center" style="padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px"><?php echo $emp_number;?></td>
						<td align="center" width="262" style="padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px"><?php echo $name;?>			
						</td>
					</tr>
					<?php }?>
</tr>
