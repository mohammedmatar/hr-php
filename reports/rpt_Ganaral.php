...
<table style="border-style:solid; border-width:0; border-collapse: collapse; padding-left:4px; padding-right:4px; padding-top:1px; padding-bottom:1px" dir="ltr" id="table5">
	<tr>
		...
		<table border="0" width="100%" id="table6">
			...
			<tr>
				...
				<p align="center">LEAD TECHNOLOGY GENERAL REPORT</td>
			</tr>
			<tr>
...
?></td>
	...
	<tr>
		...
		<b><span lang="ar-sa"><font size="2">#</font></span></b></td>
		...
		<p align="center"><b><font size="1">Employee </font></b>
		<?php if(!empty($_POST["emp_id"])){?>
		<td align="center" valign="top" bgcolor="#E6B86B" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
		<font size="1"><b>Job Id
</b></font></td><?php }?>
...
(2)</b></font></td>
		...
		<td align="center" valign="top" bgcolor="#E6B86B" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
		<font size="1"><b>Insurance date</b></font></td>
		<?php }?>
		...
		<td align="center" valign="top" bgcolor="#E6B86B" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
		<font size="1"><b>Work starting date</b></font></td><?php }?>
		...
		<td align="center" valign="top" bgcolor="#E6B86B" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
		<font size="1"><b>Jop</b></font></td><?php }?>
	...
	<?php if(!empty($_POST["expout"])){ ?>
		...
		<td align="center" valign="top" bgcolor="#E6B86B" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
		<font size="1"><b>Experience within</b></font></td>
		
		
		<td align="center" valign="top" bgcolor="#E6B86B" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
		<font size="1"><b>In moths</b></font></td><?php }?>
		...
		<td align="center" valign="top" bgcolor="#E6B86B" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
		<font size="1"><b>Annual vacation balance</b></font></td>
		<?php }?>
	</tr>
	<?php 	
		mysql_query("SET NAMES 'utf8'");
...
$counter=$i+1;
	...
	if($sex_id==1) echo "Male"; else echo "Female";
	?></font></td>
		<?php }?>
				<?php if(!empty($_POST["bdate"])){?>
	...
	<?php if(!empty($_POST["phone1"])){?>
		...
		<td <?php if($i%2==0){?> bgcolor="#FFFFFF"<?php  } else {?>bgcolor="#E6E6E6"<?php }?> style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" align="center">
		<font size="2">
		<?php $st_id=mysql_result($rs,$i,'status_id'); if($st_id==2) echo "Single"; else echo "Merraid"; ?></font></td><?php }?>
		<?php if(!empty($_POST["chield"])){ ?>
		<td <?php if($i%2==0){?> bgcolor="#FFFFFF"<?php  } else {?>bgcolor="#E6E6E6"<?php }?> style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" align="center">
		<font size="2">
