...
<table border="0" width="80%" style="border-collapse: collapse; border: 1px solid #C0C0C0" dir="rtl"  class="tb_bgcolrform">
	<tr>
		<td colspan="4" class="tdtitle">لائحة الجزاءات - البنود</td>
	</tr>
	<tr>
	...
	<tr>
		<td width="19%" height="25" align="left"><font size="2"><b>الفصل</b></font></td>
	...
	<tr>
		<td width="19%" height="25" align="left"><font size="2"><b>الإجراء</b></font></td>
		<td width="34%" height="25">
		<select size="1" name="discount">
		<option value="1" <?php if(mysql_result($rs_select,0,'discount')==1) echo "selected";?>>خصم من المرتب</option>
		<option value="0"  <?php if(mysql_result($rs_select,0,'discount')==0) echo "selected";?>>لا يوجد خصم</option>
		</select></td>
	</tr>
	<tr>	
		<td width="20%" height="25" align="left">
		<font size="2"><b>عدد ايام الخصم</b></font></td>
		<td width="29%" height="25">
...
<?php 
	...
	$testPage->paginate(); 
	$table = "<table border=\"1\" width=\"95%\" style=\"border-collapse: collapse\" dir=\"rtl\" height=\"10%\"><td align=\"center\" class=\"tdtitle\">#</td><td align=\"center\" class=\"tdtitle\">الفصل</td><td  align=\"center\" class=\"tdtitle\">البند</td></td><td align=\"center\" class=\"tdtitle\">الاجراء</td><td align=\"center\" class=\"tdtitle\">أيام الخصم</td><td align=\"center\" class=\"tdtitle\">&nbsp;</td>";
