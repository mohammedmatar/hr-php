     ...
     {  
         ...
         {  
             ...
             {  
                 ...
                 {  
                     $this->return .= ($i == $this->current_page /*And $_GET['pagination_page'] != 'All'*/) ? "<a title=\"الصفحة $i من $this->num_pages\" class=\"current\" href=\"#\">$i</a> ":"<a class=\"paginate\" title=\"الصفحة $i من $this->num_pages\" href=\"$_SERVER[PHP_SELF]?".curPageParamter('pagination_page')."&pagination_page=$i\">$i</a> ";  
                 }  
