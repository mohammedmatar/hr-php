...
<table border="0" width="45%"  dir="ltr" class="tb_bgcolrform">
	<tr>
		...
		<td class="tdtitle">
		<input type="submit" value="new" name="new_col" class="button" /></td>
	</tr>
</table>
</div>
</form>
...
<table border="1" width="90%" id="table2" style="border-collapse: collapse" dir="ltr">
	<tr>
		...
		<td width="151" align="center"class="tdtitle"><span lang="en-us">
		Contract Date</span></td>
		<td width="150" align="center"class="tdtitle"><span lang="en-us">
		Department</span></td>
	...
	<tr class="<?php echo $rowclass; ?>">
		...
		<img border="0" alt="إختيار" title="إختيار"  src="images/icon-32-edit.jpg" width="24" height="25"></a></font></td>
	</tr>
	<?php 
	}
