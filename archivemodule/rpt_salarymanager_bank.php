...
<form method="POST" action="reports/rpt_salary_bank.php">
	<div align="center">
...
<table width="40%" style="border-style:solid; border-width:1px; border-collapse: collapse; padding-left:4px; padding-right:4px; padding-top:1px; padding-bottom:1px" dir="rtl" bgcolor="#F9F9F9" id="table5">
	<tr>
		<td colspan="4" class="tdtitle"><span lang="ar-sa">إعداد المرتبات</span>
	...
	<tr>
		<td bgcolor="#FF0000">
		<p align="left"><font color="#FFFFFF">حفظ في الارشيف</font></td>
		<td bgcolor="#FF0000">
		<input type="checkbox" name="archive" value="1" checked></td>
