...
<table border="0" width="40%" style="border-collapse: collapse; border: 1px solid #C0C0C0" dir="rtl" class="tb_bgcolrform">
	<tr>
		<td colspan="2" class="tdtitle">الاقسام</td>
	</tr>
	<tr>
	...
	<tr>
		<td width="15%" height="25" align="left"><b><font size="2">الإدارة</font></b></td>
	...
	<tr>
		<td width="31%" height="25" align="left"><font size="2"><b>إسم القسم</b></font></td>
...
<?php 
	...
	mysql_query("SET NAMES 'utf8'");*/
	$result = mysql_query("select count(*) as noOfrows from tb_section");
	...
	$testPage->paginate(); 
	$table = "<table border=\"1\" width=\"60%\" style=\"border-collapse: collapse\" dir=\"rtl\" height=\"10%\"><td align=\"center\" class=\"tdtitle\">#</td><td  align=\"center\" class=\"tdtitle\">الادارة</td><td  align=\"center\" class=\"tdtitle\">القسم</td></td><td align=\"center\" class=\"tdtitle\">&nbsp;</td>";
