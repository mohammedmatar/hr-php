...
if(!empty($_POST["save"]) && empty($_GET["id"]) ){
	...
	if(!empty($_POST["name"])){
		$rs_save=mysql_query("insert into   tb_employee (name,status_id,work_id,emp_number,bdate,fulladdress,phone1,phone2,phone3,sex,chaild_count,bank_id,acc_bank,tameen_date,active)
		values('$_POST[name]',$_POST[status_id],$_POST[work_id],$_POST[emp_number],'$_POST[bdate]','$_POST[fulladdress]',$_POST[phone1],$_POST[phone2],$_POST[phone3],$_POST[sex],$_POST[chaild_count],$_POST[bank_id],$_POST[acc_bank],'$_POST[tameen_date]',$_POST[active])");
		if($rs_save){
...
<table width="80%" style="border-style:solid; border-width:1px; padding-left:4px; padding-right:4px; padding-top:1px; padding-bottom:1px" dir="ltr" class="tb_bgcolrform">
	<tr>
		...
		<span lang="en-us">Employee Personal Information</span></td>
	</tr>
	<tr>
		<td width="98%" align="left" colspan="4" class="tdtitleemp">
	...
	<tr>
		...
		<td width="14%" height="25" align="left"><span lang="en-us">Job Id</span></td>
		<td width="36%" height="25"><input type="text" name="emp_number" size="10" AUTOCOMPLETE="Off" class="text" value="<?php if(!empty($_GET["id"])) echo @mysql_result($rs_select,0,'emp_number');else echo "0";?>"><span lang="en-us"></td>
	</tr>
	<tr>
		<td width="14%" height="25" align="left"><span lang="en-us">
		<font size="2"><b>Gender</b></font></span></td>
		...
		<td width="14%" height="25" align="left"><span lang="en-us">Birth Date</span></td>
	...
	<tr>
		...
		<span lang="en-us">Work Center</span></td>
		...
		<input type="text" name="fulladdress" size="41" AUTOCOMPLETE="Off"   value="<?php if(!empty($_GET["id"])) echo @mysql_result($rs_select,0,'fulladdress'); else echo "السودان";?>"></td>
	</tr>
	<tr>
		<td width="14%" height="25" align="left"><span lang="en-us">Social 
		Status</span></td>
		...
		<span lang="en-us">Children</span></td>
	...
	<tr>
		<td width="14%" height="25" align="left"><span lang="en-us">Exchange 
		Center</span></td>
		<td width="25%" height="25">
		...
		<td width="14%" height="25" align="left"><span lang="en-us">Bank Account 
		Number</span></td>
		<td width="36%" height="25">
		<font size="2"><b>
	...
	<tr>
			<td width="14%" height="25" align="left"><font size="2"><b><span lang="en-us">Phone 
			Number1</span></b></font></td>
			<td width="25%" height="25">
			...
			<td width="14%" height="25" align="left"><span lang="en-us"><font size="2"><b>
			Phone Number 2</b></font></span></td>
			<td width="25%" height="25">
	...
	<tr>
		<td>
		<p align="left"><span lang="en-us">Active ?</span></td>
		<td>
		<font size="3">
