...
$rs_save=mysql_query(" update   lk_jop set 
				name='$_POST[name]'	,holiday=$_POST[holiday],exp=$_POST[exp]	where id=$_GET[id] ");
if($rs_save)
...
<table border="0" width="40%" style="border-collapse: collapse; border: 1px solid #C0C0C0" dir="ltr" class="tb_bgcolrform">
	<tr>
		<td colspan="2" class="tdtitle">Jobs</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<font size="2"><b>Job Name</b></font></span></td>
	...
	<tr>
		<td width="20%" height="25" align="left"><span lang="en-us">
		<font size="2"><b>Vacations Days Number</b></font></span></td>
		<td width="80%" height="25">
	...
	<tr>
		<td width="20%" height="25" align="left"><font size="2"><b>Maximum Experience</b></font></td>
		<td width="80%" height="25">
