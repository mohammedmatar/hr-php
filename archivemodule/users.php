...
<table border="0" width="41%" style="border-collapse: collapse; border: 1px solid #C0C0C0" dir="ltr" class="tb_bgcolrform">
	...
	<tr>
		...
		<font size="2"><b>Username</b></font></span></td>
	...
	<tr>
		<td width="31%" height="25" align="left"><span lang="en-us">
		<font size="2"><b>Password</b></font></span><font size="2"><b></b></font></td>
		<td width="66%" height="25">
	...
	<?php if(!empty($_GET["id"])) $tper=@mysql_result($rs_select,0,'per');?>
		...
		<option value="1" <?php if ( $tper==1) echo "selected";?>>General Manager</option>
		<option value="2" <?php if ( $tper==2) echo "selected";?>>Manager</option>
...
<?php 
	...
	$testPage->paginate(); 
	$table = "<table border=\"1\" width=\"60%\" style=\"border-collapse: collapse\" dir=\"rtl\" height=\"10%\"><td align=\"center\" class=\"tdtitle\">#</td><td  align=\"center\" class=\"tdtitle\">Name</td><td align=\"center\" class=\"tdtitle\">Authorization</td><td align=\"center\" class=\"tdtitle\">&nbsp;</td>";
