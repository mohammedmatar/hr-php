...
<form method="POST" action="reports/rpt_salafyat.php">
	<div align="center">
...
<table width="40%" style="border-style:solid; border-width:1px; border-collapse: collapse; padding-left:4px; padding-right:4px; padding-top:1px; padding-bottom:1px" dir="ltr" bgcolor="#F9F9F9" id="table5">
	<tr>
		<td colspan="4" class="tdtitle"><span lang="en-us">Monthly Advances 
		Report-according to advance type</span></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<span lang="en-us">advance type</span></td>
		<td width="61%" height="25" valign="top" colspan="3">
		<select size="1" name="salaf">
		<?php 
		mysql_query("SET NAMES 'utf8'");

		$rs_bank=mysql_query("select *from lk_loan_type");
	...
	<tr>
		<td width="37%" height="25" align="left" valign="top">
		<span lang="en-us"><font size="2">month</font></span></td>
