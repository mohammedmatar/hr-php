<?php 
	...
	$result = mysql_query("select count(*) as noOfrows from tb_collaborator where dis_salary =1");
	...
	if(isset($_REQUEST['name']))
		$rs_data=mysql_query("select * from   tb_collaborator  where dis_salary =1 and name  like '%$_REQUEST[name]%' order by id desc  $testPage->limit");
	else
		$rs_data=mysql_query("select * from   tb_collaborator where dis_salary =1  order by id desc  $testPage->limit");
...
<table border="0" width="36%"  dir="rtl" align="center" class="tb_bgcolrform">
	<tr>
		<td class="tdtitle">search by name</td>
		<td class="tdtitle">
...
<div align="center">
<table border="1" width="90%" id="table2" style="border-collapse: collapse" dir="rtl">
	<tr>
		<td width="44" align="center" class="tdtitle">#</td>
		<td align="center" class="tdtitle"><span lang="en-us">name</span></td>
		<td width="151" align="center"class="tdtitle"><span lang="en-us">date of 
		contract </span></td>
	...
	<tr class="<?php echo $rowclass; ?>">
		...
		<a href="index.php?mnu_id=2&page=coll_lone.php&emp_id=<?php echo mysql_result($rs_data,$j,'id');?>">
