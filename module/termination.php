...
$mess="edit failed !";
					...
					$mess="please complete the data".$_POST['date']."+".$_POST['other_amount'];
}
...
<table border="0" width="80%" style="border-collapse: collapse; border: 1px solid #C0C0C0" dir="ltr" class="tb_bgcolrform">
	<tr>
		<td colspan="4" class="tdtitle"><span lang="en-us">End of Service</span></td>
	</tr>
	<tr>
...
<?php 
	...
	$testPage->paginate(); 
	$table = "<table border=\"1\" width=\"60%\" style=\"border-collapse: collapse\" dir=\"ltr\" height=\"10%\"><td align=\"center\" class=\"tdtitle\">#</td><td  align=\"center\" class=\"tdtitle\">Name</td></td><td  align=\"center\" class=\"tdtitle\">Cause</td></td><td align=\"center\" class=\"tdtitle\">&nbsp;</td>";
