...
<form method="POST" action="reports/amsDailyrptemp.php">
	<div align="center">
...
<table width="40%" style="border-style:solid; border-width:1px; border-collapse: collapse; padding-left:4px; padding-right:4px; padding-top:1px; padding-bottom:1px" dir="ltr" bgcolor="#F9F9F9" id="table8">
	<tr>
		<td colspan="2" class="tdtitle">Collaborators Attendance Report</td>
	</tr>
	<tr>
	...
	<tr>
		<td width="37%" height="23" align="left" valign="top">
		report type</td>
		<td width="61%" height="23" valign="top">
	...
	<tr>
		<td width="37%" height="27" align="left" valign="top">
		<span lang="ar-sa">department </span></td>
		<td width="61%" height="27" valign="top">
