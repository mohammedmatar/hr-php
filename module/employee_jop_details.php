...
if(!empty($_POST["save"]) && !empty($_GET["id"])){
	$rs_save=mysql_query(" update   tb_employee set come_date  ='$_POST[come_date]'  ,	begin_date ='$_POST[begin_date]',	end_date ='$_POST[end_date]',			test_end_date ='$_POST[test_end_date]',			dept_id=    $_POST[dept_id],			section_id=    $_POST[section_id] ,			job_id=    $_POST[job_id],			cat_id =    $_POST[cat_id],			exp_out= $_POST[exp_out],			exp_in=$_POST[exp_in],			con_test_months=$_POST[con_test_months],			dayofmonth=$_POST[dayofmonth],			note='$note',			prom_date='$_POST[prom_date]'						where id=$_GET[id] ");
	//echo " update   tb_employee set come_date  ='$_POST[come_date]'  ,	begin_date ='$_POST[begin_date]',	end_date ='$_POST[end_date]',			test_end_date ='$_POST[test_end_date]',			dept_id=    $_POST[dept_id],			section_id=    $_POST[section_id] ,			job_id=    $_POST[job_id],			cat_id =    $_POST[cat_id],			exp_out= $_POST[exp_out],			exp_in=$_POST[exp_in],			con_test_months=$_POST[con_test_months],			dayofmonth=$_POST[dayofmonth],			note='$note',			prom_date='$_POST[prom_date]'						where id=$_GET[id] ";
		if($rs_save){
		$mess="data saved";
		}else
...
<table width="80%" style="border-style:solid; border-width:1px; padding-left:4px; padding-right:4px; padding-top:1px; padding-bottom:1px" dir="ltr" class="tb_bgcolrform">
	<tr>
		<td width="98%" align="left" colspan="4" class="tdtitleemp">employee job information</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<font size="2"><b>hiring date</b></font></span></td>
		...
		<td width="24%" height="25" align="left"><span lang="en-us">
		<font size="2"><b>work starting date</b></font></span></td>
	...
	<tr>
		<!--td width="24%" height="25" align="left"><font size="2"><b>
		Contract Duration in Years</b></font></td>
		<td width="25%" height="25">
		...
		<td width="24%" height="25" align="left"><span lang="en-us">
		<font size="2"><b>testing duration in months</b></font></span></td>
		<td width="25%" height="25">
	...
	<tr>
		<td width="24%" height="25" align="left"><span lang="en-us">
		<font size="2"><b>testing duration end</b></font></span></td>
		<td width="36%" height="25">
	...
	<tr>
		...
		<tr>
		<td width="24%" height="25" align="left"><span lang="en-us">
		<font size="2"><b>experience </b></font></span></td>
		<td width="36%" height="25">
		...
		<td width="24%" height="25" align="left" valign="top"><font size="2"><b>Experience within the company</b></font></td>
    ...
    <tr>	
		...
		<td width="24%" height="25" align="left"><span lang="en-us">
		<font size="2"><b>recent promotion date</b></font></span></td>
		<td width="36%" height="25">
		<input type="text" name="prom_date" id="prom_date" size="10" value="<?php if(!empty($_GET["id"])) echo @mysql_result($rs_select,0,'prom_date');?>" />
		<img id="end_date_b0"  src="images/calendar.jpg" />
					<script type="text/javascript">//<![CDATA[
						var cal = Calendar.setup({
						onSelect: function(cal) { cal.hide() }
						//,showTime: true
						});
						cal.manageFields("end_date_b0", "prom_date", "%Y-%m-%d");
				//]]></script>	
		</td>
	</tr>
    <tr>	
	...
	<tr>
		<td colspan="4">
		<div align="center">
			<table border="1" width="6" id="table1" style="border-collapse: collapse; border: 1px solid #666633">
				<tr>
					<td>
...
/*
	...
	while($row = mysql_fetch_row($result)){
		$table .="<tr><td align=\"center\">".$row[0]."</td><td align=\"center\"><font size=\"2\" face=\"Tahoma\">".$row[1]."</font></td><td align=\"center\"><a href=\"".curPageURL().curPageParamter('id')."&id=".$row[0]."\"><img border=\"0\"  alt=\"إختيار\" title=\"إختيار\" src=\"images/icon-32-edit.jpg\" width=\"24\" height=\"25\"></a></td></tr>";	
	}
	$table .= "</table>";
	echo '<br />'.$table;
