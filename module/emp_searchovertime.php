<?php 
	...
	if(isset($_REQUEST['name']))
		$rs_data=mysql_query("select * from   tb_employee  where   name  like '%$_REQUEST[name]%' order by name asc  $testPage->limit");
	else
		$rs_data=mysql_query("select * from   tb_employee   order by name asc   $testPage->limit");
	...
	if(!empty($_POST["new_emp"])){
			$_SESSION['emp_name'] = 'البيانات الاساسية';
...
<table border="0" width="45%"  dir="ltr" class="tb_bgcolrform">
	<tr>
		...
		<input type="submit" value="new employee" name="new_emp" class="button" style="font-weight: 700" /><b>
		</b></font></td>
	</tr>
</table>
</div>
...
<table border="1" width="90%" id="table2" style="border-collapse: collapse" dir="ltr">
	<tr>
		...
		<td width="80" align="center"class="tdtitle"><span lang="en-us">
		job/function id</span></td>
		<td width="107" align="center"class="tdtitle"><span lang="en-us">work 
		center</span></td>
		<td width="100" align="center"class="tdtitle"><span lang="en-us">phone 
		number</span></td>
	...
	<tr class="<?php echo $rowclass; ?>">
		...
		<a href="reports/rpt_overtimeemp_show.php?id=<?php echo mysql_result($rs_data,$j,'id');?>">
