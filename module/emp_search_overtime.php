...
<table border="0" width="36%"  dir="ltr" class="tb_bgcolrform">
	<tr>
		...
		<td class="tdtitle"><input type="submit" value="search" name="search" class="button" /></td>
	</tr>
</table>
</div>
</form>
...
<table border="1" width="90%" id="table2" style="border-collapse: collapse" dir="ltr">
	<tr>
		...
		<td width="80" align="center"class="tdtitle">job/function name</td>
	...
	<tr class="<?php echo $rowclass; ?>">
		...
		<a href="index.php?mnu_id=2&page=employ_overtime.php&emp_id=<?php echo mysql_result($rs_data,$j,'id');?>">
