...
if(!empty($_POST["save"]) && empty($_GET["id"]) ){
	...
	$mess="your data is not saved";
	}
	else
	$mess="please complete the information";
}
///////////////////Command Edit///////////////////////////////
...
<table border="1" width="41%" style="border-collapse: collapse; border: 1px solid #C0C0C0" dir="ltr" class="tb_bgcolrform">
	<tr>
		<td colspan="2" class="tdtitle"><span lang="en-us">salaries hierarchy</span></td>
	</tr>
	<tr>
	...
	<tr>
		<td width="31%" height="25" align="left"><span lang="en-us">category</span></td>
...
<table border="1" width="50%" id="table2" style="border-collapse: collapse" dir="ltr">
	<tr>
		<td width="44" align="center" class="tdtitle"><span lang="en-us">#</span></td>
		<td align="center" class="tdtitle"><span lang="en-us">category</span></td>
		<td align="center" class="tdtitle" width="243"><span lang="en-us">experience years</span></td>
	...
	<tr>
		...
		<img border="0"  alt="select" title="select"  src="images/icon-32-edit.png" width="24" height="25"></a></font></td>
	</tr>
	<?php }?>
</table>
<br>
