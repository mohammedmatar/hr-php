...
$rs_data=mysql_query("select *from   tb_employee  where des_salary <>0 and name like '%$_POST[name]%' order by name asc  $testPage->limit");
}
else
{
...
<table border="1" width="90%" id="table2" style="border-collapse: collapse" dir="ltr">
	...
	<tr class="<?php echo $rowclass; ?>">
		...
		<span lang="en-us"><?php if(mysql_result($rs_data,$j,'sex')==2)echo "انثى";?></span></td-->
		...
		<a href="index.php?mnu_id=2&page=employ_holiyday.php&emp_id=<?php echo mysql_result($rs_data,$j,'id');?>">
