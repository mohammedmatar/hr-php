...
<table width="40%" style="border-style:solid; border-width:1px; border-collapse: collapse; padding-left:4px; padding-right:4px; padding-top:1px; padding-bottom:1px" dir="ltr" bgcolor="#F9F9F9" id="table5">
	<tr>
		<td colspan="4" class="tdtitle">Total Settlement Report</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<font size="2">settlement type</font></td>
		<td width="24%" height="25" valign="top">
		<select size="1" name="D1">
		<option value="1">total settelment</option>
		<option value="2">salaries total</option>
		</select></td>
	...
	<tr>
		...
		</select>		<td width="14%" height="25" align="left" valign="top">
		year</td>
		<td width="36%" height="25" valign="top">
